<template>
  <div>
    <h1><div class="lds-hourglass"></div>loading...</h1>
    <i>did you know: {{ fact }}</i>
  </div>
</template>
...
export default {
  data() {
    const facts= [
        ...
        "jefallo uses discord in light mode",
        "ocular and vue have (nearly) the same theme colors, and ocular is made with vue",
        "this is the 60th message"
      ]
    return {
