  ...
  <div class="container">
    ...
    <div class="margined">
      ...
      <form @submit.prevent="updateUser()">
          ...
          <label for="status">status: </label><input name="status" type="text" class="input dashboard" maxlength="50" v-model="status">
          <br>
  ...
  methods: {
    ...
    async adminFeedback() {
      ...
      if(this.user !== '') {
        ...
        this.status = ''
        this.color = ''
        this.adminMessage = 'you need to put in a username'
      }
    }
  },
};
